...
QT_MOC_LITERAL(1, 12, 14), // "videoConnected"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "VideoStream\0videoConnected\0"
};
...
void VideoStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VideoStream *_t = static_cast<VideoStream *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->videoConnected(); break;
        default: ;
        }
        ...
        {
            typedef void (VideoStream::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoStream::videoConnected)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject VideoStream::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoStream.data,
      qt_meta_data_VideoStream,  qt_static_metacall, nullptr, nullptr}
};
...
void *VideoStream::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoStream.stringdata0))
        return static_cast<void*>(const_cast< VideoStream*>(this));
...
// SIGNAL 0
void VideoStream::videoConnected()
{
